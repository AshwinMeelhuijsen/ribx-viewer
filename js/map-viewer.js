(function () {
  ...
  function readSewerTypeValue(el) {
    return (
      textOf(el, ["ACJ", "GCJ", "GCK", "ACK", "SoortRiool", "soortRiool", "Soort_riool", "GebruikRiolering", "gebruikRiolering", "Riooltype", "TypeRiool"]) ||
      attrOf(el, ["soortRiool", "riooltype", "sewerType", "type"])
    );
  }
  ...
  function classifySewerType(rawValue) {
    ...
    // Veel RIBX-bestanden gebruiken alleen EN13508-2-codes.
    // Praktische standaardmapping voor snelle kaartweergave:
    ...
    return { key: "onbekend", label: `Onbekend (${raw})`, raw };
  }
  ...
  function runTests() {
    ...
    const testXmlText = '<root xmlns:gml="http://www.opengis.net/gml"><ZB_A><AAA>S1</AAA><AAD>P1</AAD><AAF>P2</AAF><AAJ>Teststraat</AAJ><AAE><gml:Point><gml:pos>115000 515000</gml:pos></gml:Point></AAE><AAG><gml:Point><gml:pos>115010 515010</gml:pos></gml:Point></AAG><ABQ>10</ABQ><ACB>300</ACB><ACJ>A</ACJ></ZB_A></root>';
